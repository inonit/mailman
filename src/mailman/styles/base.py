...
#        mlist.subject_prefix = _('[$mlist.display_name] ')
        mlist.subject_prefix = _('[NKK $mlist.display_name] ')   #nkk
...
#                                                                            
        mlist.default_nonmember_action = Action.defer  #nkk                  
#        mlist.subscription_policy = SubscriptionPolicy.confirm              
        mlist.subscription_policy = SubscriptionPolicy.moderate #nkk         
